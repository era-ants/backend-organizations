...
namespace Organizations.Model
{
    public sealed class OrganizationCategory
    {
        ...
        public static IEnumerable<OrganizationCategory> GetAll() => new[] {Transport, Culture, Food, Municipality};

        public static OrganizationCategory GetById(int id) => GetAll().First(x => x.Id == id);
    }
}